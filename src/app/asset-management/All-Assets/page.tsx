      ...
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex space-x-2">
          <button
            ...
            className="block rounded-md bg-blue-600 text-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-600 text-black"
          >
                  ...
                  {paginatedAssets.map((asset) => (
                    <tr key={asset._id}>
                      ...
                      <td className="relative whitespace-nowrap py-6 px-3 text-sm font-medium sm:pr-6 flex justify-center items-center space-x-3">
                        ...
                        {/* Conditionally render Edit & Delete if the user is the creator */}
