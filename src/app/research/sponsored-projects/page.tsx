...
export default function SponsoredProjectsPage() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        setLoading(true);
        let url = `/api/public/sponsored-projects?page=${currentPage}&limit=12`;
        ...
        if (data.data) {
          ...
          if (data.filters?.status) {
            // console.log("Statuses from API:", data.filters.status); // Debug log
            setStatuses(data.filters.status);
          }
          setPagination(data.pagination);
        } else {
          setError("Failed to fetch sponsored projects");
        }
      } catch (err) {
        setError("Error fetching sponsored projects");
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-2xl mx-auto text-blue-100">
              Our ongoing and completed sponsored research projects
            </p>
          </motion.div>
        </div>
      </div>
                  ...
                  <div className="col-span-full py-12 text-center">
                    <div className="bg-blue-50 rounded-lg p-8 max-w-lg mx-auto">
                      ...
                      <p className="text-gray-600">
                        No sponsored projects match your current filter. Try
