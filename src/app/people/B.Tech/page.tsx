...
export default function BTechStudentsPage() {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        setLoading(true);
        let url = `/api/public/student-information?page=${currentPage}&limit=${pagination.limit}&category=B.Tech`;
      ...
      <div className="relative bg-blue-800 text-white py-20">
        <div className="absolute inset-0">
          <Image
            ...
            alt="B.Tech Students Background"
            fill
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-2xl mx-auto text-blue-100">
              Our talented undergraduate students pursuing Bachelor of
              Technology
            </p>
          </motion.div>
        </div>
